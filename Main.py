...
def calculateSegmentIntersection(segment1, segment2):
    ...
    # Second line is vertical
        ...
        intersectionPoint = (segment2[0], slope(segment1) * segment2[0] + intercept(segment1))
    else:
...
while running:
    ...
    for intersection in intersections:
        drawCircle((255, 0, 0), intersection[0], intersection[1], 5)
        if distance(xPos, yPos, intersection[0], intersection[1]) < distance(xPos, yPos, closestIntersection[0], closestIntersection[1]):
            closestIntersection = intersection

#    drawLine((100, 100, 255), xPos, yPos, closestIntersection[0], closestIntersection[1])
    ...
    if math.sin(heading) == 1:  # Points straight down
        ...
        slope = math.tan(heading)  # WILL CAUSE FUTURE ISSUES
        print(slope)
    ...
    print(segment1[2], segment1[3])
    drawCircle((0, 255, 0), segment1[2], segment1[3], 5)
    drawLine((0, 255, 0), xPos, yPos, segment1[2], segment1[3])
